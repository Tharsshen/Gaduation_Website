...
import hills from '../img/hillsnew.png';
import background from '../img/backgroundbrown.png';
import platformSmallTall from '../img/smalltallnew.png';

import spriteRunLeft from '../img/sprite run left.png';
import spriteRunRight from '../img/sprite run right.png';
...
class Player {
    ...
    update() {
        ...
        else if (this.frames > 9 && (this.currentSprite === this.sprites.run.right || this.currentSprite === this.sprites.run.left)) this.frames = 0;
