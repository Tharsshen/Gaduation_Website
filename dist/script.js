...
document.getElementById('invitation-form').addEventListener('submit', (e) => {
    ...
    const message = `Hi ${name}, you are invited to Yogendran Govikrishnan's graduation congratulatory website! https://tharsshen.github.io/Gaduation_Website/dist/graduation.html`;
