...
document.getElementById('invitation-form').addEventListener('submit', (e) => {
    ...
    const message = `Hi ${name}, you are invited to visit Yogendran's Graduation Website to congratulate him. \n\nhttps://tharsshen.github.io/Gaduation_Website/dist/graduation.html`;
